...
export default function App() {
  ...
  const [screen, setScreen] = useState("landing"); // landing | config | dashboard
    ...
    >
      ...
      <div
        style={{
          ...
          height: "60vw",
          borderRadius: "50%",
          background: "radial-gradient(circle, #00ffa320 0%, transparent 70%)",
          filter: "blur(80px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      ...
      <div
        style={{
          ...
          height: "40vw",
          borderRadius: "50%",
          background: "radial-gradient(circle, #9945ff18 0%, transparent 70%)",
          filter: "blur(60px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      ...
      >
        ...
        >
          ...
          {connected && (
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              >
                {chainge.walletAddress}
              </div>
            </div>
          )}

          {!connected && (
            <div style={{ fontSize: 13, color: "#444" }}>Solana</div>
          )}
        </div>
        ...
        {screen === "config" && (
          <Config
            walletAddress={chainge.walletAddress}
        ...
        >
          open source · permissionless · no vc funding
        </div>
      </div>
    </div>
  );
